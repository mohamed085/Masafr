...
export default {
  ...
  methods: {
    ...
    async search(key) {
      ...
      console.log(this.dateKey2)
      console.log(this.dateKey1)
      ...
      const response = await fetch("https://msafr.we-work.pro/api/auth/admin/get-transactions-for-fiscal-year", requestOptions);
